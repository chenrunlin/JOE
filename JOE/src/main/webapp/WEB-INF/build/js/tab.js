    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<ul>',
                    '<li class="kit-item" data-target="refresh"><i class="layui-icon">&#x1002;</i> 刷新当前选项卡</li>',
                    '<li class="kit-line"></li>',
                    '<li class="kit-item" data-target="closeCurrent"><i class="layui-icon">&#x1006;</i> 关闭当前选项卡</li>',
                    '<li class="kit-item" data-target="closeOther"><i class="layui-icon">&#x1006;</i> 关闭其他选项卡</li>',
                    '<li class="kit-line"></li>',
                    '<li class="kit-item" data-target="closeAll"><i class="layui-icon">&#x1006;</i> 关闭所有选项卡</li>',
                    '</ul>',
                    '</div>',
        ...
        load: function() {
            return layer.load(0, { shade: [0.5, '#333'] });
        },
